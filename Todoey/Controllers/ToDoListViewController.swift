...
//        itemArray.remove(at: indexPath.row)
    ...
    @IBAction func addButtonPressed(_ sender: UIBarButtonItem) {
        ...
        //local variable to pass what is in the "alert.addTextField" line to the "let action = UIAlertAction" line
    ...
    // the optional parameter gives you the opportunity to sort the tableview.reloaddata()
